      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 pb-10">
        ...
        <div className="bg-white p-6 rounded-2xl shadow-md border-l-8 border-gray-300 flex items-center justify-between gap-4">
          <div className="flex flex-col flex-1">
            ...
            <input
              type="text"
              placeholder="例如：恐龍的演化..."
              className="w-full px-3 py-1.5 rounded-lg border-2 border-gray-50 focus:border-green-400 focus:outline-none text-sm"
              onKeyDown={(e) => {
                if (e.key === 'Enter') {
          ...
          <button
            ...
            className="bg-green-500 text-white px-4 py-2 rounded-xl font-bold hover:bg-green-600 transition-colors shadow-sm"
          >
            GO
          </button>
        </div>
